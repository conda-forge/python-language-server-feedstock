...
validate_recipe_outputs "python-language-server-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="python-language-server-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi