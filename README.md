About python-language-server-feedstock
======================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/python-language-server-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5725&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-language-server-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `python-language-server` can be installed with `conda`:
...
```
mamba install python-language-server
```

It is possible to list all of the versions of `python-language-server` available on your platform with `conda`:
...
```
mamba search python-language-server --channel conda-forge
```
...
mamba repoquery search python-language-server --channel conda-forge

# List packages depending on `python-language-server`:
mamba repoquery whoneeds python-language-server --channel conda-forge

# List dependencies of `python-language-server`:
mamba repoquery depends python-language-server --channel conda-forge
```
